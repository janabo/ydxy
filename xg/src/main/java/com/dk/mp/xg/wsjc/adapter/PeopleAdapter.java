...
import com.dk.mp.xg.wsjc.ui.Sswz.SswzSelectPersonActivity;
...
public class PeopleAdapter extends RecyclerView.Adapter<PeopleAdapter.MyViewHolder>{
    private SswzSelectPersonActivity activity;
    private Context mContext;
    private List<Sswz> mData;
    private LayoutInflater inflater;
    private HashMap<String, Object> isSelected = new HashMap<String, Object>();

    public PeopleAdapter(Context mContext, List<Sswz> mData,SswzSelectPersonActivity activity) {
