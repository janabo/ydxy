 ...
 */
public class SswzDjPersonsAdapter extends RecyclerView.Adapter{
    private List<Zssdjgl> mData;
    private Context mContext;
    private LayoutInflater mInflater;
    private SswzDjMainActivity activity;

    public SswzDjPersonsAdapter(List<Zssdjgl> mData, Context mContext, SswzDjMainActivity activity) {
        this.mData = mData;
