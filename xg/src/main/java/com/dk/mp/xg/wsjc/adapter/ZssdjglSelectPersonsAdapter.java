...
/**
 * 住宿生登记管理选人
 * 作者：janabo on 2017/2/8 15:09
 */
public class ZssdjglSelectPersonsAdapter extends RecyclerView.Adapter<ZssdjglSelectPersonsAdapter.MyViewHolder>{
    private SelectPersonsActivity activity;
    ...
    public ZssdjglSelectPersonsAdapter(Context mContext, List<Zssdjgl> mData, SelectPersonsActivity activity) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ZssdjglSelectPersonsAdapter.MyViewHolder(view);
    }
