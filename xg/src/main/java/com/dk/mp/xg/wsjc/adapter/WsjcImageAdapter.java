 ...
 */
public class WsjcImageAdapter extends RecyclerView.Adapter<WsjcImageAdapter.MyViewHolder>{
    private WsjcDetailActivity activity;
    private Context mContext;
    private List<String> data;
    private LayoutInflater inflater;

    public WsjcImageAdapter(Context context, WsjcDetailActivity activity,List<String> basicList) {
