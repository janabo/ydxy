...
/**
 * 作者：janabo on 2017/2/15 14:38
 */
public class SswzDecodeThread extends Thread {
    ...
    public SswzDecodeThread(SswzMainActivity activity, int decodeMode) {
    ...
    public void run() {
        Looper.prepare();
        handler = new SswzDecodeHandler(activity, hints);
