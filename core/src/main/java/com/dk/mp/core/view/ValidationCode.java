...
public class ValidationCode extends View {
    ...
    private void getAttrValues(Context context,AttributeSet attrs) {
        ...
        mCodeString = typedArray.getString(R.styleable.IndentifyingCode_text);
        typedArray.recycle();
    }
    /**
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 给画笔设置随机颜色
            mTextPaint.setARGB(255, 27, 85, 123);
            canvas.drawText(String.valueOf(mCodeString.charAt(i - 1)), (i-1) * charLength * 1.4f+30, mHeight * 2 / 3f, mTextPaint);
            canvas.restore();
        }
        // 产生干扰效果1 -- 干扰点
...
//        }
    ...
    private int measureWidth(int widthMeasureSpec) {
        int result = (int) (mTextWidth*1.5f);
    ...
    private int measureHeight(int heightMeasureSpec) {
        int result = (int) (mTextWidth/1.4f);
...
// 最大值模式，即布局文件中layout_width或layout_height一般为wrap_content
    ...
    public void setText(String mCodeString,Context mContext){
