...
public class PullToRefreshView extends LinearLayout {
	...
	private void addHeaderView() {
		// header view
		mHeaderView = mInflater.inflate(R.layout.core_refresh_header, this, false);
	...
	private void addFooterView() {
		// footer view
		mFooterView = mInflater.inflate(R.layout.core_refresh_footer, this, false);
	...
	private void footerPrepareToRefresh(int deltaY) {
		if (bool) {
			...
			if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight) && mFooterState != RELEASE_TO_REFRESH) {
				mFooterTextView.setText(R.string.xlistview_footer_hint_ready);
				...
				mFooterImageView.clearAnimation();
				mFooterImageView.startAnimation(mFlipAnimation);
				mFooterTextView.setText(R.string.xlistview_footer_hint_normal);
	...
	private void footerRefreshing() {
		...
		mFooterTextView.setText(R.string.xlistview_header_hint_loading);
